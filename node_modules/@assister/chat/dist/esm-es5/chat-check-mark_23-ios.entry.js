...
import { r as registerInstance, h, c as createEvent, H as Host, d as getElement, e as getIonMode$1, f as config, i as isPlatform, j as readTask, w as writeTask, k as getAssetPath, l as getMode } from './core-24e7d29b.js';
import { h as hasShadowDom, c as clamp, d as debounceEvent, f as findItemLabel } from './helpers-b7c9db54.js';
...
var Conversation = /** @class */ (function () {
    ...
    class_1.prototype.scrollToBottom = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.content.scrollToPoint(0, height * 2, 800)];
            });
        });
    };
...
var Message = /** @class */ (function () {
    ...
    Object.defineProperty(Message.prototype, "footerExists", {
        get: function () {
    ...
    Message.prototype.render = function () {
        ...
        return (h("ion-item", { lines: "none", class: "item" }, h("div", { slot: alignment === 'left' ? 'start' : 'end', class: "bubble " + this.direction + " " + (this.footerExists ? 'bubble-footer-padding' : '') }, h("slot", null), h("div", { class: "footer" }, this.footer &&
            h("span", { class: "footer-text" }, this.footer), h("chat-message-status", { state: this.state })), this.triangle != "none" &&
            h("div", { class: "triangle " + this.direction + " " + this.triangle + "-" + alignment }))));
    };
...
var Pane = /** @class */ (function () {
    ...
    class_2.prototype.addMessage = function (direction, text) {
    ...
    class_2.prototype.scrollToBottom = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.conversation.scrollToBottom()];
            });
        });
    };
    class_2.prototype.addOutgoingMessage = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    class_2.prototype.addIncomingMessage = function (text) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    class_2.prototype.addCard = function (_a) {
    ...
    class_2.prototype.addButton = function (_a) {
        var text = _a.text, action = _a.action;
        return __awaiter(this, void 0, void 0, function () {
            var button;
            return __generator(this, function (_b) {
    ...
    Object.defineProperty(class_2.prototype, "pane", {
...
var Fab = /** @class */ (function () {
    ...
    class_3.prototype.handleClick = function () {
    ...
    App.prototype.componentDidLoad = function () {
        {
            rIC(function () {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./tap-click-17c10da0.js').then(function (module) { return module.startTapClick(config); });
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-828cb27d.js').then(function (module) { return module.startStatusTap(); });
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    import('./input-shims-c96fb210.js').then(function (module) { return module.startInputShims(config); });
                }
...
var Card = /** @class */ (function () {
    ...
    Card.prototype.render = function () {
        var _a;
        var mode = getIonMode$1(this);
        return (h(Host, { class: Object.assign(Object.assign((_a = {}, _a[mode] = true, _a), createColorClasses$1(this.color)), { 'card-disabled': this.disabled, 'ion-activatable': this.isClickable() }) }, this.renderCard(mode)));
    };
...
var Content = /** @class */ (function () {
    ...
    class_4.prototype.onClick = function (ev) {
        if (this.isScrolling) {
            ev.preventDefault();
            ev.stopPropagation();
        }
    };
    class_4.prototype.shouldForceOverscroll = function () {
        var _a = this, forceOverscroll = _a.forceOverscroll, mode = _a.mode;
        return forceOverscroll === undefined
            ? mode === 'ios' && isPlatform('ios')
            : forceOverscroll;
    };
    class_4.prototype.resize = function () {
        if (this.fullscreen) {
    ...
    class_4.prototype.readDimensions = function () {
    ...
    class_4.prototype.onScroll = function (ev) {
        var _this = this;
     ...
     */
    class_4.prototype.getScrollElement = function () {
     ...
     */
    class_4.prototype.scrollToTop = function (duration) {
     ...
     */
    class_4.prototype.scrollToBottom = function (duration) {
        if (duration === void 0) { duration = 0; }
     ...
     */
    class_4.prototype.scrollByPoint = function (x, y, duration) {
     ...
     */
    class_4.prototype.scrollToPoint = function (x, y, duration) {
        if (duration === void 0) { duration = 0; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    class_4.prototype.onScrollStart = function () {
        var _this = this;
    ...
    class_4.prototype.onScrollEnd = function () {
        clearInterval(this.watchDog);
        this.watchDog = null;
        if (this.isScrolling) {
            this.isScrolling = false;
    ...
    class_4.prototype.render = function () {
        ...
        this.resize();
        return (h(Host, { class: Object.assign(Object.assign({}, createColorClasses$1(this.color)), (_a = {}, _a[mode] = true, _a['content-sizing'] = hostContext('ion-popover', this.el), _a['overscroll'] = forceOverscroll, _a)), style: {
...
var Textarea = /** @class */ (function () {
    ...
    class_8.prototype.disabledChanged = function () {
        this.emitStyle();
    };
    /**
    ...
    class_8.prototype.disconnectedCallback = function () {
        {
    ...
    class_8.prototype.runAutoGrow = function () {
        var nativeInput = this.nativeInput;
     ...
     */
    class_8.prototype.checkClearOnEdit = function () {
        if (!this.clearOnEdit) {
            return;
        }
    ...
    class_8.prototype.focusChange = function () {
...
var ToolbarTitle = /** @class */ (function () {
    ...
    ToolbarTitle.prototype.render = function () {
        ...
        var size = this.getSize();
        return (h(Host, { class: Object.assign((_a = {}, _a[mode] = true, _a["title-" + mode] = true, _a["title-" + size] = true, _a), createColorClasses$1(this.color)) }, h("div", { class: "toolbar-title" }, h("slot", null))));
    };
...
var Toolbar = /** @class */ (function () {
    ...
    Toolbar.prototype.render = function () {
        ...
        return (h(Host, { class: Object.assign(Object.assign((_a = { 'in-toolbar': hostContext('ion-toolbar', this.el) }, _a[mode] = true, _a), childStyles), createColorClasses$1(this.color)) }, h("div", { class: "toolbar-background" }), h("div", { class: "toolbar-container" }, h("slot", { name: "start" }), h("slot", { name: "secondary" }), h("div", { class: "toolbar-content" }, h("slot", null)), h("slot", { name: "primary" }), h("slot", { name: "end" }))));
    };
