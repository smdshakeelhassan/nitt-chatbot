import { r as registerInstance, e as getIonMode, c as createEvent, f as config, h, d as getElement } from './core-24e7d29b.js';
...
import { t as transition } from './index-ecf0e12a.js';
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await import('./swipe-back-f1625998.js')).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
