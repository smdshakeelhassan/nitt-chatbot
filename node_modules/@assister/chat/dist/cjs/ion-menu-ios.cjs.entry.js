...
require('./animation-d3ea0fd3.js');
const cubicBezier = require('./cubic-bezier-5c1f2fae.js');
const index = require('./index-f13a2988.js');
const index$1 = require('./index-0a4e87c7.js');
...
const Menu = class {
    ...
    async connectedCallback() {
        if (this.type === undefined) {
            this.type = core.config.get('menuType', this.mode === 'ios' ? 'reveal' : 'overlay');
        }
        const el = this.el;
...
`);
        ...
        this.gesture = (await new Promise(function (resolve) { resolve(require('./index-f13a2988.js')); })).createGesture({
            el: document,
