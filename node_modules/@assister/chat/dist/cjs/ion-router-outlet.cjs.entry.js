...
const cubicBezier = require('./cubic-bezier-5c1f2fae.js');
const frameworkDelegate = require('./framework-delegate-3ab849d3.js');
const index = require('./index-e9f1ae8e.js');
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        this.gesture = (await new Promise(function (resolve) { resolve(require('./swipe-back-cee6f828.js')); })).createSwipeBackGesture(this.el, () => !!this.swipeHandler && this.swipeHandler.canStart() && this.animationEnabled, () => this.swipeHandler && this.swipeHandler.onStart(), step => this.ani && this.ani.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
