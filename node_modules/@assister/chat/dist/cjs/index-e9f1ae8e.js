...
const iosTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./ios.transition-6d9e2e56.js')); });
const mdTransitionAnimation = () => new Promise(function (resolve) { resolve(require('./md.transition-8803dab7.js')); });
...
const animation = async (animationBuilder, opts) => {
    ...
    let trans;
    try {
        const mod = await new Promise(function (resolve) { resolve(require('./index-117b9d12.js')); });
